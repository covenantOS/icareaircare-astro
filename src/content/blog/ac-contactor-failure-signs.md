---
title: "AC Contactor Failure Symptoms and Replacement Cost"
description: "AC contactor failure symptoms: humming outdoor unit, chatter, or a click with no start. Contactor vs capacitor, and published $150 to $350 replacement ranges."
tag: "AC Repair"
date: "Jul 22, 2026"
read: "11 min"
...
<h2>AC contactor replacement cost</h2>
<p>The good news about a contactor is that it is one of the least expensive repairs in HVAC. Published contractor-market ranges put <strong>ac contactor replacement cost</strong> at <strong>$150 to $350</strong> for parts and labor. That band covers the part, the labor to de-energize and discharge the cabinet, land the wiring, and test the unit under load. Single-pole versus double-pole contactors and amperage ratings are what stretch the range. Those are market bands, not an I Care Air Care price list.</p>
<div class="not-prose my-6 overflow-x-auto">
  <table class="min-w-full border border-slate-200 rounded-lg overflow-hidden text-[15px]">
    <thead class="bg-brand-50 text-navy-700">
      <tr>
        <th class="text-left font-bold p-3 border-b border-slate-200">Published repair</th>
        <th class="text-left font-bold p-3 border-b border-slate-200">Typical market range</th>
      </tr>
    </thead>
    <tbody class="bg-white text-slate-700">
      <tr class="border-b border-slate-100"><td class="p-3 font-semibold">AC contactor replacement</td><td class="p-3">$150 to $350</td></tr>
      <tr class="border-b border-slate-100"><td class="p-3 font-semibold">Run capacitor replacement</td><td class="p-3">$180 to $320</td></tr>
    </tbody>
  </table>
</div>
<p>Ask for the current diagnostic fee when you book. If we complete the repair on the same call, that fee is credited toward the work.</p>
...
<p>A contactor is a fast, affordable fix in the right hands, and it is one of the parts we carry stocked on every truck across Pasco, Hillsborough, and Polk counties. Ask for the current diagnostic fee when you book. If we complete the repair on the same call, that fee is credited toward the work, and every part we install carries a 1-year parts-and-labor workmanship warranty. As a Rheem Pro Partner with a 4.9-star rating across more than 700 Google reviews, we would rather replace a failed contactor today than your compressor next week.</p>
<p>Call Tim and the team at <a href="tel:+18133952324">(813) 395-2324</a> or book online, and let us get clean, reliable power flowing to your compressor again. We dispatch from Foamflower Boulevard in Wesley Chapel, so <a href="/service-areas/wesley-chapel-ac-repair/">AC repair in Wesley Chapel</a> is our shortest route of the day, and we cover <a href="/services/ac-repair-tampa/">AC repair</a> throughout Tampa, Land O' Lakes, Lutz, New Tampa, Odessa, and Zephyrhills.</p>
