...
<p>Warm air at the grille with the outdoor unit running often points upstream, not to the compressor. The indoor evaporator coil needs a steady volume of warm return air flowing across it to work; starve it, and the coil gets too cold, condensation freezes on the fins, and airflow drops to almost nothing. If you can already see ice, work through our guide to a <a href="/blogs/frozen-evaporator-coil-tampa/">frozen evaporator coil</a> before anything else, because the system has to thaw before a technician can read it. You'll feel the last bit of cool air give way to room-temperature air as the ice grows.</p>
